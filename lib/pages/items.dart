...
class _ItemsState extends State<Items> {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              _buildTextField(_name, 'Item Name'),
              _buildTextField(_type, 'Item Type'),
              _buildTextField(_brand, 'Brand'),
              _buildTextField(_priceSell, 'Selling Price'),
              _buildTextField(_priceBuy, 'Buying Price'),
              SizedBox(height: 16),
              ElevatedButton(
                onPressed: () {
  ...
  void insertData() async {
    ...
    await inser_data_to_items_Firebase().insertItems(
