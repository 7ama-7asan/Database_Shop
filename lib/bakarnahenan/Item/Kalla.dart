...
// class Kalla extends StatefulWidget {
//   @override
//   State<Kalla> createState() => _KallaState();
// }

// class _KallaState extends State<Kalla> {
...
//                               ),
//                               onPressed: () async {
//                                 controller1.text = value.list[index].name;
//                                 controller2.text =
//                                     value.list[index].id.toString();
//                                 controller3.text = value.list[index].num;
